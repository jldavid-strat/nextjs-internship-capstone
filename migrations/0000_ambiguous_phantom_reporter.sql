...
ALTER TABLE "project_discussion_comments" ADD CONSTRAINT "project_discussion_comments_project_discussion_id_project_discussions_id_fk" FOREIGN KEY ("project_discussion_id") REFERENCES "public"."project_discussions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "kanban_column_id_idx" ON "kanban_columns" USING btree ("id");--> statement-breakpoint
CREATE INDEX "label_id_idx" ON "labels" USING btree ("id");--> statement-breakpoint
CREATE INDEX "project_id_idx" ON "projects" USING btree ("id");--> statement-breakpoint
CREATE INDEX "task_id_idx" ON "tasks" USING btree ("id");--> statement-breakpoint
