...
export const memberRoleName = pgEnum('member_role_name', [
  'public',
  'owner',
  'admin',
  'team_leader',
...
export const kanbanColumns = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('kanban_name_unique_idx').using(
      'btree',
...
export const projectDiscussionComments = pgTable(
  'project_discussion_comments',
  {
    ...
    id: bigint({ mode: 'number' })
      .primaryKey()
      .generatedAlwaysAsIdentity({
        name: 'project_discussion_comments_id_seq',
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 9223372036854775807,
