...
export default function HomePage() {
  return (
    <div className="from-platinum-900 to-platinum-800 dark:from-outer_space-500 dark:to-payne's_gray-500 min-h-screen bg-linear-to-br">
      {/* Header */}
      <header className="border-french_gray-300 dark:border-payne's_gray-400 dark:bg-outer_space-500/80 border-b bg-white/80 backdrop-blur-xs">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="text-blue_munsell-500 text-2xl font-bold">ProjectFlow</div>
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/sign-up"
                className="bg-blue_munsell-500 hover:bg-blue_munsell-600 rounded-lg px-4 py-2 text-white"
              >
                Get Started
              </Link>
            </div>
